...
hidden_nodes1 = 40
hidden_nodes2 = 30 # round(hidden_nodes1 * mulitplier)
hidden_nodes3 = 20 # round(hidden_nodes2 * mulitplier)
hidden_nodes4 = 10 # round(hidden_nodes2 * mulitplier)
...
y5 = tf.nn.softmax(tf.matmul(y4, W5) + b4)
